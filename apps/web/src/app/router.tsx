...
export const routes = [
  ...
  { path: "/pendencias", label: "Pendências", icon: ClipboardList, page: PendingChangesPage, section: "Operação" },
  { path: "/operacoes", label: "Operações", icon: Shield, page: OperationsPage, section: "Operação" },
  { path: "/equipamentos", label: "Equipamentos", icon: Tractor, page: EquipmentPage, section: "Operação" },
  ...
  { path: "/testes", label: "Testes", icon: TestTube2, page: TestCenterPage, section: "Configuração e sistema" },
  { path: "/configuracoes", label: "Configurações", icon: Settings, page: SettingsPage, section: "Configuração e sistema" }
] as const;
